...
Employee::Employee(string pesel, string name, string surname, string dateOfEmployment, size_t previousWorkPeriod) : id{ assignEmployeeId() } {
	this->pesel = pesel;
	this->name = name;
...
ostream& operator<<(ostream& output, Employee& employee) {
	output << "Identyfikator pracownika: " << employee.getId() << endl
